...
CAUSAL_EXPLANATION_CONTRACT_VERSION = "certificate-explain/2.8"
CAUSAL_INPUT_VERSION = "causal-projection/2.8"
    ...
    for field in CAUSAL_DIMENSION_FIELDS:
        ...
        dimensions[field] = {
            ...
            "properties": {
                ...
                "explanation": {"type": "string", "enum": [cause["causal_statement"]]},
...
def validate_causal_explanation(result: Dict[str, Any], certificate: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for field in CAUSAL_DIMENSION_FIELDS:
        ...
        if item["causal_statement"] != statement or item["explanation"] != statement:
            raise OllamaAuditError(
                f"explicação deve ser exatamente o enunciado causal: {field}"
            )
    ...
    return {"categorical_echoes_match": True, "cause_codes_match": True,
            ...
            "dimension_explanations_match_exactly": True,
