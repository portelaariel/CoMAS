"""Version 2.1 regression campaign for verifier-derived causal explanations."""
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Testa explicações causais v2.1 sem atuar na rede")
