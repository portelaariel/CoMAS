"""Version 2.9 regression campaign for verifier-derived causal explanations."""
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Testa explicações causais v2.9 sem atuar na rede")
